...
interface PopulationData {
    year: string;  // ou 'number' se preferir
    value: number; // Este deve ser um número representando a população
}
...
export default function CountryPage({
    ...
    return (
        ...
        <div className="w-40 h-40 rounded bg-gray-200 flex items-center justify-center">
