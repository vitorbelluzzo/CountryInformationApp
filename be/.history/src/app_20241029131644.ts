...
app.get('/:countryName/:countryCode', async (req, res) => {
    ...
    try {
        ...
        const countryInfo = {
            ...
            populationData: populationData?.populationCounts || [], // retorna array vazio caso não encontre
            flagURL: flagData ? flagData.flag : "Flag URL not found" // mensagem padrão caso não encontre
        };
